...
public class Restaurant {
	...
	private static Menu createMenu(){
		Menu menu = new Menu();
		menu.add(new MenuItem("Rawr", Menu.APPETIZERS, Menu.NOT_HEART_HEALTHY, 3.45));
		menu.add(new MenuItem("Meep", Menu.APPETIZERS, Menu.HEART_HEALTHY, 5.65));
		menu.add(new MenuItem("LAWLZ", Menu.MAIN_DISH, Menu.NOT_HEART_HEALTHY, 34.45));
		menu.add(new MenuItem("Durr", Menu.MAIN_DISH, Menu.HEART_HEALTHY, 14.45));
		menu.add(new MenuItem("What", Menu.MAIN_DISH, Menu.HEART_HEALTHY, 21.00));
		menu.add(new MenuItem("Derp", Menu.MAIN_DISH, Menu.NOT_HEART_HEALTHY, 17.45));
		menu.add(new MenuItem("Gelato", Menu.DESSERT, Menu.HEART_HEALTHY, 8.30));
		menu.add(new MenuItem("Why", Menu.DESSERT, Menu.NOT_HEART_HEALTHY, 14.45));
	...
	private static boolean validCategory(int n){
		if(n == Menu.APPETIZERS || n == Menu.MAIN_DISH || n == Menu.DESSERT)
			return true;
		return false;			
